...
//
// Subdue, version 5.1.2 - GBAD, version 1.4
//---------------------------------------------------------------------------
...
#define SUBDUE_VERSION "1.4/5.2.1"
...
typedef struct 
{
   ...
   BOOLEAN override;     // Override beam, limit and nsubs with calculated values
   ...
   BOOLEAN minOnly;      // If TRUE, only print substructure with minimum
                         // anomalous score
...
SubList* CreateSubstructureAndInstancesList(SubList *, Parameters *);
SubList* CopySubList(SubList *subList, Parameters *parameters);
SubList* PrintMaxPartialAnomalousInstances(SubList *, Parameters *);
SubList* PrintMaxPartialSubstructureInstances(SubList *, Parameters *);
void RemoveSimilarSubstructures(SubList *, Parameters *);
SubList *FindAnomalousSubstructure(SubList *, Parameters *);
SubList* AddAnomalousInstancesToBestSubstructure(SubList *,Parameters *);

void PrintAnomalousInstances(SubList *, Parameters *);
void FlagAnomalousVerticesAndEdges(InstanceList *,Graph *,Substructure *,Parameters *);
...
void PrintAnomalousVertex(Graph *, ULONG, LabelList *, Instance *, Parameters *);
void PrintAnomalousEdge(Graph *, ULONG, LabelList *, Instance *, Parameters *);
void PrintAnomalousInstance(Instance *, Graph *, Parameters *);
void PrintAnomalousInstanceList(InstanceList *, Graph *, Parameters *);
void PrintAnomalousPosInstanceList(Substructure *, Parameters *);
void PrintAnomalousNegInstanceList(Substructure *, Parameters *);
...
void AddReferenceEdge(ReferenceGraph *graph, ULONG sourceVertexIndex,
                      ...
                      ULONG labelIndex, ULONG *edgeListSize,
...
ReferenceGraph *ExtendRefGraph(ReferenceGraph *refGraph, Substructure *bestSub,
                               ULONG *vertexListSizePtr, ULONG *edgeListSizePtr,
                               Graph *fullGraph, Parameters *parameters);
