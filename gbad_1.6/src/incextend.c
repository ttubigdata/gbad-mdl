...
//          (ULONG *vertexListSizePtr) - pointer to the size of the vertex list
//          (ULONG *edgeListSizePtr) - pointer to the size of the edge list
                               ...
                               Graph *fullGraph, Parameters *parameters)
{
   ...
   *vertexListSizePtr = newGraph->numVertices;
   *edgeListSizePtr = newGraph->numEdges;
            ...
            if (!edge->used && edge->validPath)
            {
                  ...
                  else
        	  {
                  ...
                  AddReferenceEdge(newGraph, firstVertex, secondVertex,
                                   directed, labelIndex, edgeListSizePtr, FALSE);
