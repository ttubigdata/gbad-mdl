   ...
   if (instanceList != NULL) 
   {
      ...
      while (instanceListNode != NULL) 
      {
         if (instanceListNode->instance != NULL) 
         {
	       ...
	       //             out and the code below (up until the "FreeGraph...")
	       //             put into its place (also, the "counter" code above 
	       //             and below was also originally commented out too).
	       //
	       //             For some reason, when the baseline SUBDUE code is used,
	       //             this can occasionally cause Segmentation Faults with GBAD.  
