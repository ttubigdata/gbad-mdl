...
// NOTE:  There are two issues with this function:
//
//        (1) We should return ALL of the substructures that have the same
//            minimum number of instances.
//        (2) We should check for SUB_# where # is the (iteration -1) number
//            so that we are not looking at previous iteration's subs.
//
// LOOK AT FindAnomalousSubstructure FOR AN EXAMPLE OF HOW TO DO THIS....
//
