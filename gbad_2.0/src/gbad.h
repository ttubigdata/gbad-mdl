...
InstanceList *FindAnomalousAncestors(Substructure *, Graph *, Parameters *);
InstanceList *FindPotentialAnomalousAncestors(Substructure *, Graph *, Parameters *);
InstanceList *ExtendAnomalousInstancesByEdge(InstanceList *, Substructure *,
                                             Graph *, Edge *, Graph *, 
                                             double, Parameters *);
