                                 ...
                                 Parameters *parameters)
{
   ...
   if (firstInstanceListNode != NULL)
      printf("Anomalous Instance(s):\n");
//////////////////////////////////////////////// WFE - DEBUG
//printf("Inside PrintProbabilisticAnomalies...\n");
//printf("   InstanceList:\n");
//if (firstInstanceListNode != NULL) {
//   PrintInstanceList(instanceList, posGraph, parameters->labelList);
//   printf("\n");
//} else
//   printf("      ... NONE\n\n");
//////////////////////////////////////////////// WFE - DEBUG
...
//---------------------------------------------------------------------------
// NAME: PrintMaxPartialAnomalousInstances (GBAD-P)
//
// INPUTS: (SubList *subList) - list of substructures
//         (Parameters *parameters)
//
                            ...
                            Parameters *parameters)
{
   ...
   if (instance != NULL)
   {
      ...
      {
         printf("    ");
         PrintAnomalousVertex(graph, instance->vertices[i], labelList, instance);
      }
      for (i = 0; i < instance->numEdges; i++)
      {
         printf("    ");
         PrintAnomalousEdge(graph, instance->edges[i], labelList, instance);
      }
   }
}
