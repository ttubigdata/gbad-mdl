...
//
// Subdue, version 5.2 - GBAD, version 1.0
//---------------------------------------------------------------------------
...
#define SUBDUE_VERSION "1.0/5.2.1"
...
typedef struct 
{
   ...
   double mpsThreshold;  // Max Partial Substructure (MPS) threshold
...
void StoreAnomalousEdge(Edge *, ULONG, ULONG, ULONG, ULONG, BOOLEAN, BOOLEAN, BOOLEAN);
void PrintAnomalousVertex(Graph *, ULONG, LabelList *, Instance *);
void PrintAnomalousEdge(Graph *, ULONG, LabelList *, Instance *);
...
void AddVertex(Graph *, ULONG, ULONG *);
